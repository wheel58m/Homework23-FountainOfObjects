...
class Program {
    static void Main(string[] args) {
        ...
        Utility.WriteInstruction("Once you have entered the cavern, you will be able to move around the cavern by typing the direction you want to move. You can move north, south, east, or west. You can type \"quit\" to quit the game at any time.");
        Console.WriteLine();
